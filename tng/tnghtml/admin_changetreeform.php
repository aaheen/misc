...
<table border="0" cellpadding="2" class="normal">
	...
	<tr>
		...
		<td>
			<select name="newtree" class="bigselect" onchange="if(document.changetree.newtree.selectedIndex > 0) generateID('<?php echo $entity; ?>',document.changetree.newID,document.changetree.newtree);">
<?php
			echo $treelist;
?>
			</select> 
	...
	<tr>
		...
		<td>
			...
			<input type="button" class="btn" value="<?php echo $admtext['generate']; ?>" onclick="if(document.changetree.newtree.selectedIndex > 0) generateID('person',document.changetree.newID,document.changetree.newtree);">
			<input type="button" class="btn" value="<?php echo $admtext['check']; ?>" onclick="if(document.changetree.newtree.selectedIndex > 0) checkID(document.changetree.newID.value,'person','checkmsg',document.changetree.newtree);">

		</td>
	</tr>
	<tr>
		<td></td><td><input type="radio" name="operation" value="0" checked/> <?php echo $admtext['move']; ?> &nbsp; <input type="radio" name="operation" value="1"/> <?php echo $admtext['copy']; ?></td>
	</tr>
	<tr>
