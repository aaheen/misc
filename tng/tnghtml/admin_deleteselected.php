...
foreach( array_keys($_POST) as $key ) {
	if( substr( $key, 0, 3 ) == "del" ) {
		...
		elseif( !empty($xtreeaction) ) {
			include("micro_deletetrees.php");
			$items[] = $thisid;
		}
		elseif( !empty($xuseraction) || !empty($xruseraction) ) {
