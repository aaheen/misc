...
if(!isset($tree)) $tree = "";
$tng_search_cemeteries = !empty($_SESSION['tng_search_cemeteries']) ? $_SESSION['tng_search_cemeteries'] : "";
...
<table border="0" cellpadding="10" cellspacing="2" class="adm-rounded-table">
<tr>
<td class="tngshadow databack">
	<p class="nameheader"><?php echo $row['cemname']; ?></p>	<table class="label">
	...
	<tr>
		...
		<td><input type="text" value="<?php echo $row['maplink']; ?>" name="maplink" id="maplink" size="60"><input type="hidden" id="maplink_org" value="<?php echo $row['maplink']; ?>"><input type="hidden" id="maplink_last"> <input type="button" class="btn" value="<?php echo $admtext['select'] . "..."; ?>" OnClick="javascript:FilePicker('maplink','headstones');"></td>
	</tr>
...
?>
	...
	<tr><td><?php echo $admtext['cap_country']; ?>:</td>
		<td>
...
?>
	...
	<tr><td><?php echo $admtext['linkplace']; ?>:</td><td><input type="text" value="<?php echo $row['place']; ?>" name="place" id="place" class="longfield" onblur="fillCemetery(this.value);"> 
		<a href="#" onclick="return openFindPlaceForm('place');" title="<?php echo $admtext['find']; ?>"><img src="img/search.png" alt="<?php echo $admtext['find']; ?>" class="alignmiddle" /></a>&nbsp;
		<input type="button" class="btn" value="<?php echo $admtext['fillplace']; ?>" onclick="fillPlace(document.form1);"/></td></tr>
