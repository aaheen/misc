...
<?php
	if( $row['sourceID'] ) {
?>
	<tr><td><?php echo $admtext['source']; ?>:</td>
		<td>
            <input type="text" name="sourceID" id="sourceID2" value="<?php echo $row['sourceID']; ?>" size="20" /> &nbsp;<?php echo $admtext['text_or']; ?> &nbsp;
			<input type="button" class="btn" value="<?php echo $admtext['find']; ?>" onclick="return initFilter('editcitation','findsource','sourceID2','sourceTitle2');">
			<input type="button" class="btn" value="<?php echo $admtext['create']; ?>" onclick="return initNewItem('source', document.newsourceform.sourceID, 'sourceID2', 'sourceTitle2', 'editcitation','newsource');">
		</td>
	</tr>
...
?>
	<tr><td><?php echo $admtext['page']; ?>:</td><td><input type="text" name="citepage" value="<?php echo $row['page']; ?>" size="60"></td></tr>
	<tr><td><?php echo $admtext['reliability']; ?>*:</td>
		<td>
			<select name="quay" class="bigselect">
				<option value=""></option>
	...
	<tr><td><?php echo $admtext['citedate']; ?>:</td><td><input type="text" name="citedate" value="<?php echo $row['citedate']; ?>" size="60" onBlur="checkDate(this);"></td></tr>
