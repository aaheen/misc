...
<table border="0" cellpadding="2" class="label">
	...
	<tr><td><?php echo $admtext['collpath']; ?>:</td><td><input type="text" name="path" size="50" value="<?php echo $row['path']; ?>"><input type="hidden" id="newcoll_org" value="<?php echo $row['path']; ?>"/></td></tr>
	...
	<tr><td><?php echo $admtext['colllike']; ?>:</td>
		<td>
			<select name="liketype" class="bigselect">
<?php
...
?>
	...
	<tr style="height:35px">
		<td><?php echo $admtext['showon']; ?>:</td>
		<td>
			<input type="checkbox" value="1" <?php if($row['whatsnew']) echo "checked "; ?>name="whatsnew" /> <?php echo $admtext['onwhatsnew']; ?>
			<input type="checkbox" value="1" <?php if($row['statistics']) echo "checked "; ?>name="statistics" /> <?php echo $admtext['onstats']; ?>
			<input type="checkbox" value="1" <?php if($row['menus']) echo "checked "; ?>name="menus" /> <?php echo $admtext['onmenus']; ?>
		</td>
	</tr>
</table>
<br />
...
<input type="submit" class="btn" value="<?php echo $admtext['save']; ?>">
