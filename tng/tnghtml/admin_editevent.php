...
<table border="0" cellpadding="2">
	...
	<tr><td><?php echo $admtext['eventdate']; ?>:</td><td><input type="text" name="eventdate" id="eventdate" value="<?php echo $row['eventdate']; ?>" onBlur="checkDate(this);"> <?php echo $admtext['dateformat']; ?>:</td></tr>
	<tr><td><?php echo $admtext['eventplace']; ?>:</td><td valign="top"><input type="text" name="eventplace" id="eventplace" class="verylongfield" value="<?php echo $row['eventplace']; ?>"> &nbsp;<?php echo $admtext['text_or']; ?>&nbsp;
	...
	<tr>
		...
		<td>
			<table cellpadding="0"><tr><td><input type="text" name="dupIDs" id="dupIDs" value="" class="medfield"> &nbsp;<?php echo $admtext['text_or']; ?>&nbsp;</td>
				<td><a href="#" onclick="return findItem('<?php echo $row['type']; ?>','dupIDs','','<?php echo $row['gedcom']; ?>','<?php echo $assignedbranch; ?>');" title="<?php echo $admtext['find']; ?>"><img src="img/search.png" class="alignmiddle" alt="<?php echo $admtext['find']; ?>" /></a></td></tr>
			</table>
		</td>
	</tr>
	<tr>
