...
<?php
	...
	if( tng_num_rows( $langresult ) ) {
		...
		while( $langrow = tng_fetch_assoc($langresult)) {
			...
			$displayrows .= "<tr><td>$display</td><td><input type=\"text\" name=\"$displayname\" size=\"40\" value=\"$displayval\" onFocus=\"if(this.value == '') this.value = document.form1.defdisplay.value;\"></td></tr>\n";
...
<div class="admin-main">
	...
	<tr>
		...
		<td>
			<select name="type" class="bigselect" onChange="populateTags(this.options[this.selectedIndex].value,'');">
	...
	<tr>
		<td><?php echo $admtext['selecttag']; ?>:</td>
		<td>
			<select name="tag1" class="bigselect" onChange="if(this.options[this.selectedIndex].value == 'EVEN') {toggleTdesc(1);} else {toggleTdesc(0);}">
	...
	<tr id="tdesc"><td><?php echo $admtext['typedescription']; ?>*:</td><td><input type="text" name="description" size="40" value="<?php echo $row['description']; ?>"></td></tr>
	<tr id="displaytr"<?php echo $displaytrstyle; ?>><td><?php echo $admtext['display']; ?>:</td><td><input type="text" name="defdisplay" size="40" value="<?php echo $defdisplay; ?>"></td></tr>
<?php
	if( $displayrows ) {
?>	
	<tr><td colspan="2">
	...
	<table id="otherlangs"<?php echo $otherlangsstyle; ?>>
		<tr><td colspan="2"><br /><b><?php echo $admtext['allnone']; ?></b><br /><br /></td></tr>
<?php
	echo $displayrows;
?>
	</table>
...
?>
	<tr><td><?php echo $admtext['displayorder']; ?>:</td><td><input type="text" name="ordernum" size="4" value="<?php echo $row['ordernum']; ?>"></td></tr>
	<tr><td><?php echo $admtext['evdata']; ?>:</td><td><input type="radio" name="keep" value="1" <?php if( $row['keep'] ) echo "checked"; ?>> <?php echo $admtext['accept']; ?> &nbsp; <input type="radio" name="keep" value="0" <?php if( $row['keep'] != 1 ) echo "checked"; ?>> <?php echo $admtext['ignore']; ?></td><td></td></tr>
	<tr><td><?php echo $admtext['collapseev']; ?>:</td><td><input type="radio" name="collapse" value="1" <?php if( $row['collapse'] ) echo "checked"; ?>> <?php echo $admtext['yes']; ?> &nbsp; <input type="radio" name="collapse" value="0" <?php if( $row['collapse'] != 1 ) echo "checked"; ?>> <?php echo $admtext['no']; ?></td><td></td></tr>
	<tr><td><?php echo $admtext['ldsevent']; ?>:</td><td><input type="radio" name="ldsevent" value="1" <?php if( $row['ldsevent'] ) echo "checked"; ?>> <?php echo $admtext['yes']; ?> &nbsp; <input type="radio" name="ldsevent" value="0" <?php if( $row['ldsevent'] != 1 ) echo "checked"; ?>> <?php echo $admtext['no']; ?></td><td></td></tr>
	</table><br/>
	...
	<p id="typereq" style="display:none">*<?php echo $admtext['typerequired']; ?></p>
	</form>
	</div>
</div>
<script type="text/javascript">
