...
<table border="0" cellpadding="2" class="normal">
	<tr><td><?php echo $admtext['title2']; ?>:</td><td><input type="text" name="title" size="60" maxlength="128" value="<?php echo $row['title']; ?>" style="width:500px"></td></tr>
	...
	<tr>
		...
		<td>
			<select name="mwtree" class="bigselect" onchange="tree=this.options[this.selectedIndex].value">
<?php
if( $assignedtree ) {
...
<br /><input type="button" class="btn" value="<?php echo $admtext['selphoto']; ?>" onclick="return openMostWantedMediaFind(document.editmostwanted.mwtree.options[document.editmostwanted.mwtree.selectedIndex].value);" />
<div id="mwphoto">
<table width="95%" cellpadding="5" cellspacing="1" style="background-color:#e6e6e6; margin-top:6px">
	<tr>
