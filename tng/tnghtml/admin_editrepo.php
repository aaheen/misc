...
function addNewMedia() {
	...
	window.open('admin_newmedia.php?personID=<?php echo $repoID; ?>&tree=<?php echo $tree; ?>&linktype=R','_blank');
	return false;
}
</script>
...
<td class="tngshadow databack">
	<table cellpadding="0" cellspacing="0">
		<tr>
			...
			<td>
				<span class="nameheader"><?php echo $row['reponame'] . " ($repoID)</span>"; ?>
...
<?php
				...
				echo "<a href=\"#\" onclick=\"return showNotes('', '$repoID');\" class=\"newsmallicon\" title=\"{$admtext['notes']}\"><img id=\"notesicon\" src=\"img/{$notesicon}\" alt=\"{$admtext['notes']}\"/></a>\n";
?>
                <br clear="all" />
				</div>
...
<?php 
	echo $admtext['otherevents'] . ": &nbsp;<input type=\"button\" class=\"btn\" value=\"  {$admtext['addnew']}  \" onclick=\"newEvent('R','$repoID','$tree');\">\n";
?>
				</strong></p>
			</td>
		</tr>
...
<?php
		$close_command = "window.location.href='admin_repositories.php';";
	}
?>
