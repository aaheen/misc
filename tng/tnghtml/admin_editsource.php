...
function addNewMedia() {
	...
	window.open('admin_newmedia.php?personID=<?php echo $sourceID; ?>&tree=<?php echo $tree; ?>&linktype=S','_blank');
	return false;
}
</script>
...
<td class="tngshadow databack">
	<table cellpadding="0" cellspacing="0">
		<tr>
			...
			<td>
				<span class="nameheader"><?php echo "$sourcename ($sourceID)</span>"; ?>
...
<?php
				...
				echo "<a href=\"#\" onclick=\"return showNotes('', '$sourceID');\" class=\"newsmallicon\" title=\"{$admtext['notes']}\"><img id=\"notesicon\" src=\"img/{$notesicon}\" alt=\"{$admtext['notes']}\"/></a>\n";
?>
                <br clear="all" />
				</div>
...
?>
	...
	<tr><td valign="top"><?php echo $admtext['actualtext']; ?>:</td><td><textarea cols="80" rows="14" name="actualtext"><?php echo $row['actualtext']; ?></textarea></td></tr>
		<tr>
			<td colspan="2">
				<br/>
				<p><strong class="subhead">
<?php 
	echo $admtext['otherevents'] . ": &nbsp;<input type=\"button\" class=\"btn\" value=\"  {$admtext['addnew']}  \" onclick=\"newEvent('S','$sourceID','$tree');\">\n";
?>
				</strong></p>
			</td>
		</tr>
