...
?>
	<tr>
		...
		<td>
			<select class="bigselect" name="<?php echo $dayname; ?>">
				<option value=""></option>
<?php
	for( $i = 1; $i <= 31; $i++ ) {
		echo "<option value=\"$i\"";
...
?>
			...
			<select class="bigselect" name="<?php echo $monthname; ?>">
				<option value=""></option>
			...
			<input type="text" name="<?php echo $yearname; ?>" size="4" value="<?php echo $row[$yearname]; ?>"/> <?php echo $help; ?>
		</td>
	</tr>
<?php
	}
...
?>
	<tr>
        ...
        <td><input type="text" name="evtitle" class="verylongfield" value="<?php echo $row['evtitle']; ?>" /></td>
    </tr>
	<tr>
        <td style="padding-top:10px" valign="top"><?php echo $admtext['evdetail']; ?>:</td>
