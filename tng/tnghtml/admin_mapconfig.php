...
<div class="admin-main">
	...
	<table class="label">
		...
		<tr>
			...
			<td>
				<select class="bigselect" name="maptype">
		...
		<tr><td><?php echo $admtext['mapstzm']; ?>:</td>
			<td>
				<select class="bigselect" name="mapstzoom">
				<?php
					for($i = 0; $i <= 17; $i++) {
						echo "<option value=\"$i\"";
		...
		<tr><td><?php echo $admtext['mapfoundzm']; ?>:</td>
			<td>
				<select class="bigselect" name="mapfoundzoom">
				<?php
					for($i = 0; $i <= 17; $i++) {
						echo "<option value=\"$i\"";
		...
		<tr><td><?php echo $admtext['startoff']; ?>:</td>
			<td>
				<select class="bigselect" name="startoff">
		...
		<tr><td><?php echo $admtext['pstartoff']; ?>:</td>
			<td>
				<select class="bigselect" name="pstartoff">
		...
		<tr><td><?php echo $admtext['conslpins']; ?>:</td>
			<td>
				<select class="bigselect" name="showallpins">
