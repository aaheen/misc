...
function doRow( $field, $textmsg, $boxname ) {
	...
	if( $r1field || $r2field ) {
		...
		echo "<td valign=\"top\" width=\"31%\" class=\"lightback\">$r1field&nbsp;</td>";
		if( is_array( $r2row ) ) {
			echo "<td width=\"10\">&nbsp;&nbsp;</td>";
			echo "<td valign=\"top\" width=\"15%\" class=\"fieldnameback\" nowrap><span class=\"fieldname\"><strong>$admtext[$textmsg]:</strong></span></td>";
			...
			if( $boxname ) {
				...
				echo "&nbsp;";
			echo "</td>";
			echo "<td valign=\"top\" width=\"31%\" class=\"lightback\">$r2field&nbsp;</td>";
		}
		else {
			echo "<td width=\"10\">&nbsp;&nbsp;</td>";
			echo "<td valign=\"top\" width=\"15%\" class=\"fieldnameback\" nowrap><span class=\"fieldname\"><strong>$admtext[$textmsg]:</strong></span></td>";
	...
	foreach( $_POST as $key=>$value ) {
		...
		switch( $prefix ) {
			case "r2":
				...
				if($varname == "addressID") {
					$r1row['address1'] = $r2row['address1'];
					$r1row['address2'] = $r2row['address2'];
					$r1row['city'] = $r2row['city'];
					$r1row['state'] = $r2row['state'];
					$r1row['country'] = $r2row['country'];
				}
...
<div class="admin-main">
	...
	<div><em><?php echo $admtext['choosemergerepos']; ?></em><br/><br/>
...
?>
	...
	<table class="label">
		<tr>
			...
			<a href="#" onclick="return findItem('R','repoID1','reponame1',document.form1.tree.options[document.form1.tree.selectedIndex].value);" title="<?php echo $admtext['find']; ?>" class="newsmallicon"><img src="img/search.png" alt="<?php echo $admtext['find']; ?>"/></a></td>
			<td width="80">&nbsp;</td>
			...
			<a href="#" onclick="return findItem('R','repoID2','reponame2',document.form1.tree.options[document.form1.tree.selectedIndex].value);" title="<?php echo $admtext['find']; ?>" class="newsmallicon"><img src="img/search.png" alt="<?php echo $admtext['find']; ?>"/></a></td>
		</tr>
	    <tr>
