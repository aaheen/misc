...
function doRow( $field, $textmsg, $boxname ) {
	...
	if( $s1field || $s2field ) {
		...
		echo "<td valign=\"top\" width=\"31%\" class=\"lightback\">$s1field&nbsp;</td>";
		if( is_array( $s2row ) ) {
			echo "<td width=\"10\">&nbsp;&nbsp;</td>";
			echo "<td valign=\"top\" width=\"15%\" class=\"fieldnameback\" nowrap><span class=\"fieldname\"><strong>$admtext[$textmsg]:</strong></span></td>";
			...
			if( $boxname ) {
				...
				echo "&nbsp;";
			echo "</td>";
			echo "<td valign=\"top\" width=\"31%\" class=\"lightback\">$s2field&nbsp;</td>";
		}
		else {
			echo "<td width=\"10\">&nbsp;&nbsp;</td>";
			echo "<td valign=\"top\" width=\"15%\" class=\"fieldnameback\" nowrap><span class=\"fieldname\"><strong>$admtext[$textmsg]:</strong></span></td>";
	...
	foreach( $_POST as $key=>$value ) {
		...
		switch( $prefix ) {
			case "s2":
				...
				$updatestr .= ", $varname = \"" . addslashes($s1row[$varname]) . "\" ";
...
<div class="admin-main">
	...
	<div><em><?php echo $admtext['choosemergesources']; ?></em><br/><br/>
...
while( $treerow = tng_fetch_assoc($treeresult) ) {
	...
	if( !empty($tree) && $treerow['gedcom'] == $tree ) $trees .= " selected";
...
?>
	...
	<table class="label">
		<tr>
			...
			<a href="#" onclick="return findItem('S','sourceID1','sourceTitle1',document.form1.tree.options[document.form1.tree.selectedIndex].value);" title="<?php echo $admtext['find']; ?>" class="newsmallicon"><img src="img/search.png" alt="<?php echo $admtext['find']; ?>"/></a></td>
			<td width="80">&nbsp;</td>
			...
			<a href="#" onclick="return findItem('S','sourceID2','sourceTitle2',document.form1.tree.options[document.form1.tree.selectedIndex].value);" title="<?php echo $admtext['find']; ?>" class="newsmallicon"><img src="img/search.png" alt="<?php echo $admtext['find']; ?>"/></a></td>
		</tr>
        <tr>
	...
	<table>
		<tr>
			<td colspan="5"><strong><?php echo $admtext['matchthese']; ?></strong></td>
			<td>&nbsp;&nbsp;&nbsp;</td>
		...
		<tr>			
			<td>
				...
				<input type="checkbox" name="clongtitle" value="yes"<?php if( isset($clongtitle) && $clongtitle ) echo " checked"; ?>> <?php echo $admtext['title2']; ?>
			</td>
			<td>&nbsp;&nbsp;&nbsp;</td>
			<td>
