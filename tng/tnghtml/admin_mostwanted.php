...
function showDiv($type) {
	...
	if($allow_add) {
		...
		echo "<input type=\"button\" value=\"" . $admtext['addnew'] . "\" class=\"btn\" style=\"float:right\" onclick=\"return openMostWanted('$type','');\"><br />\n";
		echo "</form>\n";
	}
	...
	echo "<tr>\n";
	echo "<td class=\"fieldnameback\" style=\"width:55px;border-radius:7px 0px 0px 0px\"><span class=\"fieldname\"><nobr>&nbsp;<b>" . $admtext['text_sort'] . "</b>&nbsp;</nobr></span></td>\n";
	echo "<td class=\"fieldnameback\" style=\"width:" . ($thumbmaxw+10) . "px\"><span class=\"fieldname\"><nobr>&nbsp;<b>" . $admtext['thumb'] . "</b>&nbsp;</nobr></span></td>\n";
	echo "<td class=\"fieldnameback\" style=\"border-radius:0px 7px 0px 0px\"><span class=\"fieldname\"><nobr>&nbsp;<b>" . $admtext['description'] . "</b>&nbsp;</nobr></span></td>\n";
	echo "</tr>\n";
	echo "</table>\n";
