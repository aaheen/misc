...
<td class="tngshadow databack">
	...
	<table class="label" cellspacing="2">
		<tr>
			...
			<td>
				<select name="tree" class="bigselect" id="tree1">
<?php
...
?>
		...
		<tr><td><?php echo $admtext['branchid']; ?>:</td><td><input type="text" name="branch" size="20" maxlength="20"/></td></tr>
		<tr><td><?php echo $admtext['description']; ?>:</td><td><input type="text" name="description" size="60"></td></tr>
		...
		<tr>
			...
			<td><table id="startind3" class="normal"><tr><td><input type="text" name="personID" id="personID" size="10"> &nbsp;<?php echo $admtext['text_or']; ?>&nbsp;</td>
				<td><a href="#" onclick="return findItem('I','personID','',getTree(document.getElementById('tree1')),'<?php echo $assignedbranch; ?>');" title="<?php echo $admtext['find']; ?>"><img src="img/search.png" alt="<?php echo $admtext['find']; ?>" class="alignmiddle" /></a></td>
			</tr></table></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><div id="numgens3"><input type="text" name="agens" size="3" maxlength="3" value="0"> &nbsp;&nbsp; <?php echo $admtext['descofanc']; ?>:
				<select name="dagens" class="bigselect">
