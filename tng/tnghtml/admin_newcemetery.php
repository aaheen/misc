...
<td class="tngshadow databack">
	...
	<tr>
		...
		<td><input type="text" name="maplink" id="maplink" size="60"><input type="hidden" id="maplink_org"><input type="hidden" id="maplink_last"> <input type="button" class="btn" value="<?php echo $admtext['select'] . "..."; ?>" onclick="javascript:FilePicker('maplink','headstones');"></td>
	</tr>
...
?>
	...
	<tr><td><?php echo $admtext['linkplace']; ?>:</td><td><input type="text" name="place" id="place" class="longfield" onblur="fillCemetery(this.value);"> 
...
?>
	...
	<input type="submit" name="savestay" accesskey="s" class="btn" value="<?php echo $admtext['savereturn']; ?>">
