...
?>
	...
	<tr style="height:35px">
		...
		<td>
			<input type="checkbox" value="1" checked name="whatsnew" /> <?php echo $admtext['onwhatsnew']; ?>
			<input type="checkbox" value="1" checked name="stats" /> <?php echo $admtext['onstats']; ?>
			<input type="checkbox" value="1" checked name="menus" /> <?php echo $admtext['onmenus']; ?>
		</td>
	</tr>
</table>
<br />
...
<input type="button" class="btn" name="cancel" value="<?php echo $text['cancel']; ?>" onclick="tnglitbox.remove();"> <span id="cerrormsg" style="color:#CC0000;display:none"><?php echo $admtext['cidexists']; ?></span>
</form>
</div>
