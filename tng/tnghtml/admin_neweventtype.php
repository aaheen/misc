...
<?php
	...
	if( tng_num_rows( $langresult ) ) {
		...
		while( $langrow = tng_fetch_assoc($langresult)) {
			...
			$displayrows .= "<tr><td><span class=\"normal\">$display</span></td><td><input type=\"text\" name=\"$displayname\" size=\"40\" value=\"\" onFocus=\"if(this.value == '') this.value = document.form1.defdisplay.value;\"></td></tr>\n";
...
<div class="admin-main">
	...
	<tr id="tdesc"><td><?php echo $admtext['typedescription']; ?>*:</td><td><input type="text" name="description" size="40"></td></tr>
	<tr id="displaytr"><td><?php echo $admtext['display']; ?>:</td><td><input type="text" name="defdisplay" size="40"></td></tr>
<?php
	if( $displayrows ) {
?>	
...
?>
	<tr><td><?php echo $admtext['displayorder']; ?>:</td><td><input type="text" name="ordernum" size="4" value="0"></td></tr>
	<tr><td><?php echo $admtext['evdata']; ?>:</td><td><input type="radio" name="keep" value="1" checked> <?php echo $admtext['accept']; ?> &nbsp; <input type="radio" name="keep" value="0"> <?php echo $admtext['ignore']; ?></td><td></td></tr>
	<tr><td><?php echo $admtext['collapseev']; ?>:</td><td><input type="radio" name="collapse" value="1"> <?php echo $admtext['yes']; ?> &nbsp; <input type="radio" name="collapse" value="0" checked> <?php echo $admtext['no']; ?></td><td></td></tr>
	<tr><td><?php echo $admtext['ldsevent']; ?>:</td><td><input type="radio" name="ldsevent" value="1"> <?php echo $admtext['yes']; ?> &nbsp; <input type="radio" name="ldsevent" value="0" checked> <?php echo $admtext['no']; ?></td><td></td></tr>
	</table><br/>
