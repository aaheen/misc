...
<?php if(!empty($stay)) { echo "window.opener.location.reload(false);\n"; } ?>
var persfamID = "";
...
<?php
	...
	if( !$assignedbranch ) {
		...
		$select .= "	<option value=\"\" selected>{$admtext['nobranch']}</option>\n";
...
?>
	...
	<tr>
		...
		<td>
			...
			<input type="button" class="btn" value="<?php echo $admtext['generate']; ?>" onClick="generateID('family',document.form1.familyID,document.form1.tree1);">
			<input type="button" class="btn" name="lock" value="<?php echo $admtext['lockid']; ?>" onClick="document.form1.newfamily[0].checked = true;">
			<input type="button" class="btn" value="<?php echo $admtext['check']; ?>" onClick="checkID(document.form1.familyID.value,'family','checkmsg',document.form1.tree1);">
...
<td class="tngshadow databack">
	...
	<tr><td><?php echo $admtext['husband']; ?>:</td><td><input type="text" readonly="readonly" name="husbnameplusid" id="husbnameplusid" size="40" value="<?php echo "$husbstr"; ?>">
		<input type="hidden" name="husband" id="husband" value="<?php echo (isset($husband) ? $husband : ""); ?>">
		<input type="button" class="btn" value="<?php echo $admtext['find']; ?>" onclick="return findItem('I','husband','husbnameplusid',document.form1.tree1.options[document.form1.tree1.selectedIndex].value,'<?php echo $assignedbranch; ?>');">
		...
		<input type="button" class="btn" value="<?php echo $admtext['remove']; ?>" onclick="RemoveSpouse(document.form1.husband,document.form1.husbnameplusid);">
	</td></tr>
	<tr><td><?php echo $admtext['wife']; ?>:</td><td><input type="text" readonly readonly="readonly" name="wifenameplusid" id="wifenameplusid" size="40" value="<?php echo "$wifestr"; ?>">
		<input type="hidden" name="wife" id="wife" value="<?php echo (isset($wife) ? $wife : ""); ?>">
		<input type="button" class="btn" value="<?php echo $admtext['find']; ?>" onclick="return findItem('I','wife','wifenameplusid',document.form1.tree1.options[document.form1.tree1.selectedIndex].value,'<?php echo $assignedbranch; ?>');">
		...
		<input type="button" class="btn" value="<?php echo $admtext['remove']; ?>" onclick="RemoveSpouse(document.form1.wife,document.form1.wifenameplusid);">
	</td></tr>
	</table>
...
?>
		<tr>
			...
			<td colspan="2"><input type="text" value="" name="marrtype" style="width:100%" maxlength="50"></td>
		</tr>
<?php
...
<tr>
<td class="tngshadow databack">
	<p><strong><?php echo $admtext['fevslater']; ?></strong></p>
