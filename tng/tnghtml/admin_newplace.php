...
?>
	<tr><td><?php echo $admtext['place']; ?>:</td><td><input type="text" name="place" id="place" size="70"></td></tr>
<?php
...
?>
	...
	<tr><td valign="top"><?php echo $admtext['notes']; ?>:</td><td><textarea wrap cols="90" rows="5" name="notes" id="mynotes"></textarea></td></tr>
	</table><br/>&nbsp;
