...
<td class="tngshadow databack">
	...
	<tr>
		...
		<td>
			<select name="tree1" class="bigselect" onChange="generateID('repo',document.form1.repoID,document.form1.tree1);">
<?php
...
?>
	...
	<tr>
		<td><?php echo $admtext['repoid']; ?>:</td>
		<td>
			<input type="text" name="repoID" size="10" onBlur="this.value=this.value.toUpperCase()">
			<input type="button" class="btn" value="<?php echo $admtext['generate']; ?>" onClick="generateID('repo',document.form1.repoID,document.form1.tree1);">
			<input type="submit" class="btn" name="submit" value="<?php echo $admtext['lockid']; ?>" onClick="document.form1.newscreen[0].checked = true;">
			<input type="button" class="btn" value="<?php echo $admtext['check']; ?>" onClick="checkID(document.form1.repoID.value,'repo','checkmsg',document.form1.tree1);">
...
<td class="tngshadow databack">
	<table class="label">
	<tr><td><?php echo $admtext['name']; ?>:</td><td><input type="text" name="reponame" size="40"> (<?php echo $admtext['required']; ?>)</td></tr>
...
<td class="tngshadow databack">
	...
	<input type="button" name="cancel" class="btn" value="<?php echo $text['cancel']; ?>" onClick="window.location.href='admin_repositories.php';">
</td>
</tr>
</table>
</form>
