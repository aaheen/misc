...
<td class="tngshadow databack">
	...
	<tr>
		...
		<td>
			<select name="tree1" class="bigselect" onChange="generateID('source',document.form1.sourceID,document.form1.tree1);">
<?php
...
?>
	...
	<tr>
		...
		<td>
			...
			<input type="button" class="btn" value="<?php echo $admtext['generate']; ?>" onClick="generateID('source',document.form1.sourceID,document.form1.tree1);">
			<input type="submit" class="btn" name="submit" value="<?php echo $admtext['lockid']; ?>" onClick="document.form1.newscreen[0].checked = true;">
			<input type="button" class="btn" value="<?php echo $admtext['check']; ?>" onClick="checkID(document.form1.sourceID.value,'source','checkmsg',document.form1.tree1);">
