...
?>
	<tr>
		...
		<td>
			<select class="bigselect" class="bigselect" name="<?php echo $dayname; ?>">
				<option value=""></option>
<?php
	for( $i = 1; $i <= 31; $i++ ) {
...
?>
			...
			<select class="bigselect" class="bigselect" name="<?php echo $monthname; ?>">
				<option value=""></option>
			...
			<input type="text" name="<?php echo $yearname; ?>" size="4"/> <?php echo $help; ?>
		</td>
	</tr>
<?php
	}
...
?>
	<tr>
        ...
        <td><input type="text" name="evtitle" class="verylongfield" /></td>
    </tr>
	<tr>
