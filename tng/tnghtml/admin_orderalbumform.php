...
?>
			...
			<td><input type="text" name="newlink1" id="newlink1" class="bigfield" value="<?php if( isset($personID) ) echo $personID; ?>"></td>
			<td class="normal"><input type="submit" class="btn" value="<?php echo $admtext['text_continue']; ?>"> &nbsp;<?php echo $admtext['text_or']; ?>&nbsp; </td>
