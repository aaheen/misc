...
<div class="admin-main">
	...
	<table id="ordertbl" width="100%" cellpadding="3" cellspacing="1" border="0" class="fieldname">
		<tr>
			<td class="fieldnameback" style="width:105px;border-radius:7px 0px 0px 0px">&nbsp;<b><?php echo $admtext['text_sort']; ?></b>&nbsp;</td>
			<td class="fieldnameback" style="width:100px">&nbsp;<b><?php echo $admtext['thumb']; ?></b>&nbsp;</td>
			<td class="fieldnameback">&nbsp;<b><?php echo $admtext['description']; ?></b>&nbsp;</td>
			<td class="fieldnameback" style="width:45px;">&nbsp;<b><?php echo $admtext['show']; ?></b>&nbsp;</td>
			<td class="fieldnameback" style="width:151px;border-radius:0px 7px 0px 0px">&nbsp;<b><?php echo $admtext['datetaken']; ?></b>&nbsp;</td>
		</tr>
	</table>
...
<?php
	...
	while( $row = tng_fetch_assoc( $result ) )
	{
		...
		echo "<td class=\"lightback smaller\" style=\"width:35px;text-align:center\">";
 		...
 		echo "<input class=\"movefields\" name=\"move{$row['medialinkID']}\" id=\"move{$row['medialinkID']}\" value=\"$count\" onkeypress=\"handleMediaEnter('{$row['medialinkID']}',jQuery('#move{$row['medialinkID']}').val(),event);\" />\n";
		...
		echo "<td class=\"lightback\" style=\"width:100px;text-align:center;\">";
		...
		echo "<td class=\"lightback\"><a href=\"admin_editmedia.php?mediaID={$row['mediaID']}\">{$row['description']}</a><br/>$truncated<br/>\n";
		...
		echo "</span>&nbsp;</td>\n";
		echo "<td class=\"lightback\" style=\"width:45px;text-align:center;vertical-align:top\">";
		...
		echo "<td class=\"lightback\" style=\"width:150px;\">{$row['datetaken']}&nbsp;</td>\n";
		echo "</tr></table>";
		echo "</div>\n";
		$count++;
	}
