...
?>
			...
			<td valign="top">
				<select name="mediatypeID" class="bigselect">
<?php
...
?>
			...
			<td><input type="text" name="newlink1" id="newlink1" class="bigfield" value="<?php if( isset($personID) ) echo $personID; ?>" onblur="toggleEventRow(document.find.eventlink1.checked);"></td>
			...
			<td><input type="submit" class="btn" value="<?php echo $admtext['text_continue']; ?>"></td>
		</tr>
		<tr>
			<td colspan="3">&nbsp;</td>
			<td colspan="2">
