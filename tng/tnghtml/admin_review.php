...
<?php
	...
	if( $placefield ) {
		...
		echo "<td><a href=\"#\" onclick=\"return openFindPlaceForm('newplace');\" title=\"{$admtext['find']}\"><img src=\"img/search.png\" class=\"alignmiddle\" title=\"{$admtext['find']}\" alt=\"{$admtext['find']}\" /></a></td></tr>\n";
	}
	if( $factfield ) {
...
?>
	<tr>
		...
		<td>
<?php
	$notesicon = $gotnotes ? "note_on.png" : "note.png";
	$citesicon = $gotcites ? "quotes_on.png" : "quotes.png";
	$moreicon = $gotmore ? "more_on.png" : "more.png";
	if( !is_numeric( $eventID ) )
		echo "<a href=\"#\" onclick=\"return showMore('$eventID','$persfamID');\" id=\"moreicon$eventID\" class=\"newsmallicon\" title=\"{$admtext['more']}\"><img id=\"moreicon$label\" src=\"img/{$moreicon}\" alt=\"{$admtext['more']}\"/></a>\n";
	echo "<a href=\"#\" onclick=\"return showNotes('$eventID','$persfamID');\" id=\"notesicon$eventID\" class=\"newsmallicon\" title=\"{$admtext['notes']}\"><img id=\"notesicon\" src=\"img/{$notesicon}\" alt=\"{$admtext['notes']}\"/></a>\n";
	echo "<a href=\"#\" onclick=\"return showCitations('$eventID','$persfamID');\" id=\"citesicon$eventID\" class=\"newsmallicon\" title=\"{$admtext['sources']}\"><img id=\"citesicon\" src=\"img/{$citesicon}\" alt=\"{$admtext['sources']}\"/></a>\n";
?>
		</td>
	</tr>
	<tr><td colspan="2">&nbsp;</td></tr>
