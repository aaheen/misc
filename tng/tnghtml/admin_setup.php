...
if(!isset($templatenum)) $templatenum = "";
if(!isset($templateswitching)) $templateswitching = "0";
...
if(!isset($database_socket)) $database_socket = "";
...
?>
	...
	<form action="" class="label">
		...
		<input type="button" class="btn" value="<?php echo $admtext['createtables']; ?>" onClick="if( confirm( '<?php echo $admtext['conftabledelete']; ?>' ) ) window.location.href = 'admin_tablecreate.php';">
	</form>
<?php
	}
?>
