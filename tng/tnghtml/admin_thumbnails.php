...
<?php
	...
	$mediatabs[3] = array($allow_edit,"admin_thumbnails.php",$admtext['thumbnails'],"thumbs");
...
?>
	<tr>
		<td class="red"><?php echo $admtext['imglib']; ?></td>
	</tr>
<?php
	}
?>
...
<td class="tngshadow databack">
	...
	<div id="defaults" class="label">
	<br/>
	<form action="defphotos.php"  method="post" onsubmit="return assignDefaults(this);">
	<input type="checkbox" name="overwritedefs" value="1"> <?php echo $admtext['overwritedefs']; ?><br/>
	<input type="checkbox" name="noeventmedia" value="1"> <?php echo $admtext['noeventmedia']; ?><br/><br/>
<?php
    if($assignedtree) {
...
?>
	<?php echo $admtext['tree']; ?>: <select name="tree" class="bigselect">
<?php
