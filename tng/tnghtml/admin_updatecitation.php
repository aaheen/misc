...
$query = "UPDATE $citations_table SET sourceID=\"$sourceID\", page=\"$citepage\", quay=\"$quay\", citedate=\"$citedate\", citedatetr=\"$citedatetr\", citetext=\"$citetext\", note=\"$citenote\" WHERE citationID=\"$citationID\"";
