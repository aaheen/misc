<?php
	...
	$localphotopathdisplay = addcslashes( $localphotopathdisplay, '"\\/');
	$localhistorypathdisplay = addcslashes( $localhistorypathdisplay, '"\\/');
	$localdocumentpathdisplay = addcslashes( $localdocumentpathdisplay, '"\\/');
	$localotherpathdisplay = addcslashes( $localotherpathdisplay, '"\\/');
	$localhspathdisplay = addcslashes( $localhspathdisplay, '"\\/');
	...
	fwrite( $fp, "\$tngimpcfg['gedtrees'] = \"$gedtrees\";\n" );
	fwrite( $fp, "?>" );
