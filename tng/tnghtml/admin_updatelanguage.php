...
adminwritelog( "<a href=\"admin_editlanguage.php?languageID=$languageID\">{$admtext['modifylanguage']}: $languageID</a>" );

if( !empty($submitx) || !empty($message) ) {
	$message = $admtext['changestolanguage'] . " $display {$admtext['succsaved']}.";
