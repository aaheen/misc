...
setcookie("tng_val_post[tree]", $tree, 0);
...
?>
	<table cellpadding="5" cellspacing="1" border="0" class="rounded-table">
		<tr>
<?php
	//show headers
	$num_display_headers = count($display);
	for($i = 0; $i < $num_display_headers; $i++) {
