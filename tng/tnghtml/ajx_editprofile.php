...
?>
		...
		<tr><td><?php echo $text['pwdagain']; ?>*:</td><td><input type="password" name="password2" size="20" maxlength="100" value="<?php echo $row['password']; ?>" /></td></tr>
	        <tr><td><?php echo $text['realname']; ?>*:</td><td><input type="text" name="realname" class="longerfield" maxlength="50" value="<?php echo $row['realname']; ?>" /></td></tr>
	        <tr><td><?php echo $text['phone']; ?>:</td><td><input type="text" name="phone" class="longerfield" maxlength="30" value="<?php echo $row['phone']; ?>" /></td></tr>
	        <tr><td><?php echo $text['email']; ?>*:</td><td><input type="text" name="email" class="longerfield" maxlength="100" value="<?php echo $row['email']; ?>" /></td></tr>
	        <tr><td><?php echo $text['emailagain']; ?>*:</td><td><input type="text" name="em2" class="longerfield" maxlength="100" value="<?php echo $row['email']; ?>" /></td></tr>
	        <tr><td><?php echo $text['website']; ?>:</td><td><input type="text" name="website" class="longerfield" maxlength="128" value="<?php echo $row['website']; ?>" /></td></tr>
	        <tr><td><?php echo $text['address']; ?>:</td><td><input type="text" name="address" class="longerfield" maxlength="100" value="<?php echo $row['address']; ?>" /></td></tr>
	        <tr><td><?php echo $text['city']; ?>:</td><td><input type="text" name="city" class="longerfield" maxlength="64" value="<?php echo $row['city']; ?>" /></td></tr>
	        <tr><td><?php echo $text['state']; ?>:</td><td><input type="text" name="state" class="longerfield" maxlength="64" value="<?php echo $row['state']; ?>" /></td></tr>
	        <tr><td><?php echo $text['zip']; ?>:</td><td><input type="text" name="zip" size="20" maxlength="10" value="<?php echo $row['zip']; ?>" /></td></tr>
	        <tr><td><?php echo $text['country']; ?>:</td><td><input type="text" name="country" class="longerfield" maxlength="64" value="<?php echo $row['country']; ?>" /></td></tr>
			<tr>
