...
function doSourceSearch( $instance, $pagenav ) {
	...
	$str .= "<input type=\"text\" name=\"sourcesearch\" value=\"$sourcesearch\" class=\"longfield\" /> <input type=\"submit\" class=\"btn\" value=\"{$text['search']}\" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
	$str .= $pagenav;
...
?>
	<thead><tr>
		...
		<th data-tablesaw-priority="1" class="fieldnameback nw"><span class="fieldname">&nbsp;<?php echo $text['title2'] . ", " . $text['author']; ?>&nbsp;</span></th>
...
while( $row = tng_fetch_assoc( $result ) )
{
	...
	echo "<td valign=\"top\" class=\"databack\"><a href=\"$showsource_url" . "sourceID={$row['sourceID']}&amp;tree={$row['gedcom']}\">{$row['sourceID']}</a>&nbsp;</td>";
	echo "<td valign=\"top\" class=\"databack\"><a href=\"$showsource_url" . "sourceID={$row['sourceID']}&amp;tree={$row['gedcom']}\">$sourcetitle</a><br/>{$row['author']}&nbsp;</td>";
	if( $numtrees > 1 )
