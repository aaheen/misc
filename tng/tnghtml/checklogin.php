...
//exit;
	if( isset( $_SESSION['logged_in'] ) && (!$admin_login || ($_SESSION['allow_admin'] && $currentuser))) {
		...
		$allow_private_notes = $_SESSION['allow_private_notes'];
		...
		$_SESSION['allow_private_notes'] = isset($allow_private_notes) ? $allow_private_notes : 0;
