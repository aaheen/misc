...
<div class="databack ajaxwindow" id="finddiv">
	...
	<table>
		...
		<tr>
			<td>
				<select name="mediatypeID" class="bigselect" onChange="toggleHeadstoneCriteria(document.find2,this.options[this.selectedIndex].value); getNewMedia(document.find2,0);">
...
?>
			...
			<td>
				<select name="searchtree" class="bigselect" onchange="getNewMedia(document.find2,0)">
<?php
  		if( !$assignedtree )
...
?>
			...
			<td>
				<input type="submit" name="searchbutton" class="btn aligntop" style="margin-bottom:0px" value="<?php echo $admtext['search']; ?>">
