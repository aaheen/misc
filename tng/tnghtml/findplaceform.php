...
<div class="databack ajaxwindow" id="finddiv">
	...
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		<tr>
			...
			<td><input type="text" name="myplace" class="medfield" id="myplace" onkeyup="filterChanged(event, {form:'findform1',fieldId:'myplace', type:'L', tree:'<?php echo $tree; ?>', destdiv:'placeresults', temple:getTempleCheck()<?php echo $mediaoption; ?>});"/></td>
