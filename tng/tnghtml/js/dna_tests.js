		...
		jQuery.ajax({
			...
			success: function(req){
				if(req == "1") {
					...
					var actionbuttons = '<a href="#" title="' + remove_text + '" onclick="return deleteDnaLink(' + linkID + ');" class="newsmallericon"><img src="img/times.png" alt="' + remove_text + '" ' +'class="smallicon admin-delete-icon"/></a>';
