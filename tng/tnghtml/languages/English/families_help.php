...
<tr class="databack">
	<td class="tngshadow">
		...
		Father or Mother field (it cannot be edited directly). To edit the spouse's individual record, click the "Edit" button. 
        To remove a spouse from the relationship (does not delete the spouse from the database),
		click the "Unlink" button. To remove the spouse AND delete their record entirely, click "Delete".</p>
