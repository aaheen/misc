...
$admtext['xmatch'] = "Correspondance X";
...
$text['findplaces'] = "Trouver tous les individus avec un évènement dans ce lieu";
...
//added in 14.0
$text['oneyear'] = "an";
$text['pwdcodelink'] = "Cliquer sur ce lien pour recevoir un mot de passe provisoire";
$text['pwdcodesent'] = "Un lien de réinitialisation du mot de passe a été envoyé à votre adresse de courriel.";
$text['moved'] = "Déplacé";
$text['citation'] = "Citation";
$text['other'] = "Autre";
$text['death'] = "Décès";
$text['burial'] = "Inhumation";
$text['cremation'] = "Crémation";
$text['marriage'] = "Mariage";
$text['divorce'] = "Divorce";
$text['bylength'] = "Longueur";
$text['bymarriages'] = "Mariages";
$text['none'] = "Aucun";
...
$text['back'] = "Retour";
$text['all'] = "Tout";
$admtext['longerpwd'] = "Les mots de passe doivent comprendre de xxx à 128 caractères.";
