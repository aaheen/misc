...
//added in 14.0
$text['oneyear'] = "Jahr";
$text['pwdcodelink'] = "Auf diesen Link klicken, damit Dir ein temporäres Passwort geschickt wird";
$text['pwdcodesent'] = "Ein Link, um das Passwort zurückzusetzen, wurde an Deine Email-Adresse geschickt.";
$text['moved'] = "Verschoben";
$text['citation'] = "Zitat";
$text['other'] = "Anders";
$text['death'] = "Tod";
$text['burial'] = "Beerdigung";
$text['cremation'] = "Einäscherung";
$text['marriage'] = "Eheschließung";
$text['divorce'] = "Scheidung";
$text['bylength'] = "Schritte";
$text['bymarriages'] = "Eheschließungen";
$text['none'] = "Kein";
...
$text['back'] = "Zurück";
$text['all'] = "Alle";
$admtext['longerpwd'] = "Ein Passwort muss zwischen xxx und 128 Zeichen lang sein.";
