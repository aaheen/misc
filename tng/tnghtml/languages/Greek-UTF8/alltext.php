...
$admtext['foster'] = "θετός";
$admtext['sealing'] = "στεγανοποίηση";
$admtext['putative'] = "θεωρούμενος";
...
$text['birthabbr'] = "γ.";
$text['chrabbr'] = "c.";
$text['deathabbr'] = "θ.";  //from descend
$text['burialabbr'] = "ταφ.";  //from descend
$text['marrabbr'] = "γαμ.";
...
//added in 14.0
$text['oneyear'] = "year";
$text['pwdcodelink'] = "Click this link to have a temporary password sent to you";
$text['pwdcodesent'] = "A password reset link has been sent to your e-mail address.";
$text['moved'] = "Moved";
$text['citation'] = "Citation";
$text['other'] = "Άλλες Πληροφορίες";
$text['death'] = "Death";
$text['burial'] = "Burial";
$text['cremation'] = "Cremation";
$text['marriage'] = "Marriage";
$text['divorce'] = "Divorce";
$text['bylength'] = "Steps";
$text['bymarriages'] = "Marriages";
$text['none'] = "None";
