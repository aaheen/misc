...
//added in 14.0
$text['oneyear'] = "år";
$text['pwdcodelink'] = "Klikk denne linken for å få sendt et midlertidig passord til deg";
$text['pwdcodesent'] = "En link til siden for resetting av passordet er sendt til din epostadresse.";
$text['moved'] = "Flyttet";
$text['citation'] = "Henvisning";
$text['other'] = "Annet";
$text['death'] = "Død";
$text['burial'] = "Begravelse";
$text['cremation'] = "Kremasjon";
$text['marriage'] = "Ekteskap";
$text['divorce'] = "Skilsmisse";
$text['bylength'] = "Steg";
$text['bymarriages'] = "Ekteskap/Partnerskap";
$text['none'] = "Ingen";
...
$text['back'] = "Tilbake";
$text['all'] = "Alle";
$admtext['longerpwd'] = "Passord må være mellom xxx og 128 tegn lange.";
