...
switch ( $textpart ) {
	...
	case "connections":
		...
		$text['findrel2'] = "Znajd¼ pokrewieñstwo";
		...
		$text['hfather'] = "father";
		$text['hmother'] = "mother";
		$text['hhusband'] = "husband";
		$text['hwife'] = "wife";
		$text['hson'] = "son";
		$text['hdaughter'] = "daughter";
	...
	case "imgviewer":
		...
		//added in 15.0
		$text['showtags'] = "Poka¿ tagi";
		$text['toggletagsmsg'] = "Kliknij aby w³±czyæ/wy³±czyæ";
		break;
	...
	case "dna":
		...
		$text['keep_name_private'] = "Zachowaj prywatnoÂ¶Ã¦";
...
$text['title2'] = "Title"; //for media, sources, etc (not people)
