...
$text['collapseall'] = "Contraer todo";
...
//added in 14.0
$text['oneyear'] = "año";
$text['pwdcodelink'] = " Haga clic en este enlace y le enviaremos una contraseña temporal";
$text['pwdcodesent'] = " Se ha enviado un enlace a su dirección de correo electrónico para restablecer la contraseña";
$text['moved'] = "Movido";
$text['citation'] = "Cita";
$text['other'] = "Otra Información";
$text['death'] = "Fallecimiento";
$text['burial'] = "Entierro";
$text['cremation'] = "Incineración";
$text['marriage'] = "Matrimonio";
$text['divorce'] = "Divorcio";
$text['bylength'] = "Pasos";
$text['bymarriages'] = "Matrimonios";
$text['none'] = "Ninguno";
...
$text['back'] = "Atrás";
$text['all'] = "Todo";
$admtext['longerpwd'] = "Contraseñas deben tener entre xxx y 128 caracteres.";
