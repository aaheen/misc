...
//added in 14.0
$text['oneyear'] = "år";
$text['pwdcodelink'] = "Klicka denna länk för att få ett temporärt lösenord skickat till dig";
$text['pwdcodesent'] = "En länk för återställning av lösenord har skickats till din e-postadress.";
$text['moved'] = "Flyttad";
$text['citation'] = "Citat";
$text['other'] = "Annat";
$text['death'] = "Död";
$text['burial'] = "Begravning";
$text['cremation'] = "Kremering";
$text['marriage'] = "Vigsel";
$text['divorce'] = "Skilsmässa";
$text['bylength'] = "Steg";
$text['bymarriages'] = "Vigslar";
$text['none'] = "Ingen";
...
$text['back'] = "Tillbaka";
$text['all'] = "Allt";
$admtext['longerpwd'] = "Lösenord måste vara mellan xxx och 128 tecken.";
