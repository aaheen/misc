...
function showSlot($slot) {
	...
	return $pedigree['shownumbers'] ? "$slot. " : "";
}
...
function displayIndividual( $key, $generation, $slot ) {
	...
	//}
	echo "<td colspan=\"2\" $pedborder><span class=\"normal\">&nbsp;" . showSlot($slot) . "<a href=\"$getperson_url" . "personID=$key&amp;tree=$tree\">$name</a>&nbsp;</span></td>\n";
