...
function doGenOptions($generations,$first,$last) {
	echo '<select name="genperpage" class="bigselect">';
...
function doFontOptions($field, $default='helvetica') {
	...
	echo "<select name=\"$field\" class=\"bigselect\">";
...
<br /><p class="subhead"><span class="label" style="padding-bottom:3px"><?php echo $text[$titleidx]; ?></span><br /><?php echo $titletext; ?></p>
<?php
...
?>
<table id="genselect" cellpadding="0" class="label">
    <tr>
	<td>
	    <?php echo $text['generations']; ?>:
	</td>
	<td>
...
<?php
	...
	if($allow_blank) {
?>
<div  class="pdfblock"><input type="checkbox" id="blankform" name="blankform" value="1" /> <?php echo $text['blank']; ?></div>
<?php
	}
	...
	if($allow_cite) {
?>
<div  class="pdfblock"><input type="checkbox" id="citesources" name="citesources" value="1" checked="1"/> <?php echo $text['inclsrcs']; ?></div>
<?php
	}
if ($pdftype == "fam")
...
<table id="display" cellpadding="3" class="label">
    <tr>
	<td>
	    <?php echo $text['datesloc']; ?>:&nbsp;
	</td>
	<td>
	    <select name="getPlace" class="bigselect">
	...
	<td>
	    <?php echo $text['numsys']; ?>:&nbsp;
	</td>
	<td>
	    <select name="numbering" class="bigselect">
...
<table cellpadding="3" class="label">
	<tr>
...
<table cellpadding="3" class="label">
    <tr>
	<td>
	    <?php echo $text['pgsize']; ?>:&nbsp;
	</td>
	<td>
	    <select name="pagesize" class="bigselect">
    ...
    <tr>
	<td>
	    <?php echo $text['orient']; ?>:&nbsp;
	</td>
	<td>
	    <select name="orient" class="bigselect">
