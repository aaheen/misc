...
//$newlanguage = preg_replace("/[^0-9]/", '', $newlanguage);
$newlanguage = preg_replace("/[^0-9]/", "", ${"newlanguage".$instance});
...
if(!empty( $row['folder']) && file_exists($languages_path . $row['folder'])) {
...
if( !empty($_SESSION['destinationpage8']) )
