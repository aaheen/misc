...
?>
	...
	<li><a href="anniversaries.php"><span class="l"></span><span class="r"></span><span class="t"><?php echo $text['dates']; ?></span></a></li>
                ...
                <div>
				  <form method="get" name="searchform" action="search.php">
					...
					<input type="hidden" name="mybool" value="AND" />
						<input type="submit" style="margin-top:5px; margin-bottom:5px" class="btn" value="<?php echo $text['search']; ?>" />
					</form>
					<ul class="home-menus">
                ...
                <div class="art-blockcontent">
                    ...
                    <div class="art-blockcontent-body">
                		<div>
						  ...
						  <ul class="home-menus">
						<?php
							echo showLinks(getTemplateMessage('t10_featurelinks'), true);
						?>
						  </ul>
						</div>
                        <div class="cleared"></div>
