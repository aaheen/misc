...
?>
			<img src="<?php echo $cms['tngpath'] . $templatepath; ?><?php echo $tmp['t2_headimg']; ?>" alt="" class="headerimg" width="70" height="99" style="padding-right:50px" />
<?php
	//end HEADER IMAGE
?>
			...
			<table cellspacing="0" cellpadding="0">
				<tr>
					<td class="topmenu">
						...
						<?php echo $text['firstname']; ?>:<br /><input type="text" name="myfirstname" class="searchbox mediumfield" size="10" style="height:28px" /><br />
						<img src="<?php echo $cms['tngpath']; ?>img/spacer.gif" alt="" width="100%" height="3" /><br />
						<?php echo $text['lastname']; ?>: <br /><input type="text" name="mylastname" size="10" class="searchbox mediumfield" style="height:28px" /><br />
