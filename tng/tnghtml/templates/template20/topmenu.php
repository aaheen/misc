...
<?php
	if( $currentuser ) {
		echo "<ul>\n";
		echo "<li class=\"bullet\"><a href=\"{$cms['tngpath']}logout.php\" class=\"loginout leftnavlink\">{$text['mnulogout']}</a></li>\n";
	}
	else {
		echo "<ul>\n";
		echo "<li class=\"bullet\"><a href=\"{$cms['tngpath']}login.php\" class=\"loginout leftnavlink\">{$text['mnulogon']}</a></li>\n";
