...
$title = getTemplateMessage('t23_maintitle');

$search_header = "<h2 class=\"site-head-home\">{$text['search']}</h2>";
											...
											<div>
												<div style="font-size:16px; line-height:1.24em">
													<?php 
														...
														echo getTemplateMessage('t23_mainpara');
										...
										<div class="snips-container"">
											<div class="snip-row">
										        <article class="contentBox4a">
										        	<a href="<?php echo $tmp['t23_sniplink-1']; ?>">
								                        <div class="postcard">
								                            <div class="thumbnail">
								                                <figure><img src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t23_snipimage-1']; ?>"></figure>
								                                <div class="caption">
								                                    <p class="title2"><?php echo getTemplateMessage('t23_snipname-1'); ?></p>
								                                    <p><?php echo getTemplateMessage('t23_snipinfoone-1'); ?></p>
								                            	</div>
							                        		</div>
														</div>
								                     </a>
												...
												<article class="contentBox4b">
													<a href="<?php echo $tmp['t23_sniplink-2']; ?>">
								                      	<div class="postcard">
								                            <div class="thumbnail">
								                                <figure><img src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t23_snipimage-2']; ?>"></figure>
								                                <div class="caption">
								                                    <p class="title2"><?php echo getTemplateMessage('t23_snipname-2'); ?></p>
								                                    <p><?php echo getTemplateMessage('t23_snipinfoone-2'); ?></p>
								                                </div>
								                            </div>
								                        </div>
								                     </a>
											...
											<div class="snip-row">
												<article class="contentBox4c">
				                                    <a href="<?php echo $tmp['t23_sniplink-3']; ?>">
									                    <div class="postcard">
								                            <div class="thumbnail">
								                                <figure><img src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t23_snipimage-3']; ?>"></figure>
								                                <div class="caption">
								                                    <p class="title2"><?php echo getTemplateMessage('t23_snipname-3'); ?></p>
								                                    <p><?php echo getTemplateMessage('t23_snipinfoone-3'); ?></p>
								                                </div>
								                            </div>
									                     </div>
								                     </a>
												...
												<article class="contentBox4d">
													<a href="<?php echo $tmp['t23_sniplink-4']; ?>">
								                    	<div class="postcard">
								                            <div class="thumbnail">
								                                <figure><img src="<?php echo $cms['tngpath'] . $templatepath . $tmp['t23_snipimage-4']; ?>"></figure>
								                                <div class="caption">
								                                    <p class="title2"><?php echo getTemplateMessage('t23_snipname-4'); ?></p>
								                                    <p><?php echo getTemplateMessage('t23_snipinfoone-4'); ?></p>
