...
?>
	 ...
	 <form id="form1" method="get" action="<?php echo $cms['tngpath']; ?>search.php">
	    ...
	    <table width="297" border="0" cellspacing="5" cellpadding="0">
	    <tr>
		<td><?php echo $text['firstname']; ?>: </td>
		<td class="searchbox"><input name="myfirstname" type="text" id="myfirstname" class="mediumfield" /></td>
          
	    </tr>
	    <tr>
		<td class="normal"><?php echo $text['lastname']; ?>: </td>
		<td class="searchbox"><input name="mylastname" type="text" id="mylastname" class="mediumfield" /></td>
