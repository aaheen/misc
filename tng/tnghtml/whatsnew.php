...
if($sitever != "standard") {
	...
	$header = "<table cellpadding=\"3\" cellspacing=\"1\" border=\"0\" style=\"width:100%\" class=\"tablesaw thfixed whiteback\" data-tablesaw-mode=\"$tabletype\"{$headerr}>\n";
} else {
	$header = "<table cellpadding=\"3\" cellspacing=\"1\" border=\"0\" style=\"width:100%\" class=\"thfixed whiteback\">";
}
...
<?php
	...
	while( $row = tng_fetch_assoc($result))
	{
		...
		if( $birthplace ) {
            ...
            $birthplacestr .= "psearch=" . urlencode($birthplace) . "\"><img src=\"{$cms['tngpath']}img/tng_search_small.gif\" class=\"placeimg\" border=\"0\" alt=\"\" width=\"9\" height=\"9\" /></a>";
		}
